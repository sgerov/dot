# rbvenv config
export PATH="/usr/local/sbin:/usr/local/bin:/usr/bin:/Users/sava.gerov/.rbenv/shims:/Users/sava.gerov/.rbenv/bin$PATH"
export VISUAL=vim
...
alias grem='git fetch origin && git rebase origin/master'
alias gd='git diff'
